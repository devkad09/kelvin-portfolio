    ...
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden py-20">
      ...
      <div className="container-wide w-full px-6 md:px-12 relative z-10 text-center">
        ...
        <div className="relative mb-8">
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter mb-4 bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent">
            Creative <br /> Developer
          </h1>
        </div>

        <div className="max-w-3xl mx-auto">
           <p className="text-xl md:text-3xl font-medium text-white/50 mb-12">
              Architecting Digital Worlds
           </p>

           <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button onClick={() => go("projects")} className="btn-nebula w-full sm:w-auto">
                View Works
              </button>
              <button onClick={() => go("contact")} className="btn-nebula-outline w-full sm:w-auto">
                Let's Talk
              </button>
           </div>
        </div>
